...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent, c as createAstro, m as maybeRenderHead, d as addAttribute, s as spreadAttributes } from './astro/server_Dv6w92OM.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BTZYPnox.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/verblog/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://ver0810.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_WLVmmWF4.mjs').then(n => n._);
...
}, "/home/ancheng/WebApp/myblog/src/components/FormattedDate.astro", void 0);

export { $$FormattedDate as $, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, DEFAULT_HASH_PROPS as a, getCollection as g, renderEntry as r };
